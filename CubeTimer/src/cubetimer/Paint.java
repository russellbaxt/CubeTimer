...
public class Paint extends JPanel{
	...
	private void menu(Graphics g){
		...
		Images.typeString("Options", 0, fields.windowSize.windowHeight / 16 + (fields.windowSize.windowWidth / 20)
				* 5 + (fields.windowSize.windowWidth / 50) * 4, fields.windowSize.windowWidth / 16, fields.menuItems.getOptions(), g);
	...
	private void changeTwistyPuzzle(Graphics g){
		...
		Images.typeString("5x5x5", 0, fields.windowSize.windowWidth / 16 + (fields.windowSize.windowWidth / 40) * 4
				+ (fields.windowSize.windowWidth / 100) * 3, fields.windowSize.windowWidth / 32,
				fields.menuItems.twistyPuzzleMenu.get5x5x5(), g);
		
		Images.typeString("Mega minx", 0, fields.windowSize.windowWidth / 16 + (fields.windowSize.windowWidth / 40) * 5
				+ (fields.windowSize.windowWidth / 100) * 4, fields.windowSize.windowWidth / 32,
				fields.menuItems.twistyPuzzleMenu.getMegaMinx(), g);
		
		Images.typeString("Gear Cube", 0, fields.windowSize.windowWidth / 16 + (fields.windowSize.windowWidth / 40) * 6
				+ (fields.windowSize.windowWidth / 100) * 5, fields.windowSize.windowWidth / 32,
				fields.menuItems.twistyPuzzleMenu.getGearCube(), g);
		
		Images.typeString("Anisatropic Gear Cube", 0, fields.windowSize.windowWidth / 16
		...
		Images.typeString("One Handed 3x3x3", 0, fields.windowSize.windowWidth / 16
		...
		Images.typeString("Random Twisty Puzzle", 0, fields.windowSize.windowWidth / 16
		...
		Images.typeString("Exit", 0, fields.windowSize.windowWidth / 16 + (fields.windowSize.windowWidth / 40) * 10
